...
export class ContentProcessor extends BaseProcessor {
    ...
    async handleContentGeneration(job: Job<any>) {
        ...
        this.logger.log(`Starting content generation for lead: ${leadId} | Type: ${assetType}`);
        ...
        try {
            ...
            const content = await this.contentAgent.generateContent(brief, assetType || 'SERVICE_PAGE');
            ...
            this.logger.log(`Content generation completed for lead: ${leadId}. Asset ID: ${asset.id}`);
